...
namespace Catalog.Repositories.Connected
{
    public class ProductRepository : IDataRepository
    {
            ...
            public string conString = @"data source=shc-sql-01.database.windows.net ; database=HangFireCatalog_VG; User Id=tmgreadonly; Password=#p7P>Wzs;";
            ...
            public  bool Insert(Product product)
            {
                ...
                string query = "INSERT INTO products_shruti (Id, Name, Description, UnitPrice, Quantity, Image)"
                               + "values(" + product.ProductId + ", '" + product.Title + "','" + product.Description + "','" + product.UnitPrice + "','" + product.Quantity + "')";
            ...
            public bool Update(Product product)
            {
                ...
                string query = "UPDATE products_shruti SET Name='" + product.Title + "', Description='" + product.Description + "', UnitPrice=" + product.UnitPrice + ", Quantity=" + product.Quantity + "' WHERE id = " + product.ProductId + "";
                IDbCommand cmd = new SqlCommand(query, con as SqlConnection);
